...
import { getMonthlyIncome } from '../controllers/admin.controller.js';
...
// GET monthly income - only for admins
router.get('/monthly-income', protect, adminOnly, getMonthlyIncome);
